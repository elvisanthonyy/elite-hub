...
export async function sendVerificationMessage(
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `<div style="width: 100%; aspect-ratio: 1/1; display: block; height: fit-content; align-items: center;"><h2 style="font: bold; font-size: 30px; border: 3px solid white; margin: 0px auto; border-radius: 16px; padding: 24px; text-align: center; width: 90%; color: #03a3ff;"><img src="https://elitehub.com.ng/icons/elite-logo.svg" alt="logo" style="width: 100px; height: 100px;" /></div>
