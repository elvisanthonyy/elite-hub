...
const TestimonialComp = ({ name }: ChildProps) => {
  return (
    <div className=" relative flex flex-col px-5 py-5 border-1 border-gray-700 shrink-0 w-67 mx-3 rounded-md bg-white h-50  my-5">
      <div className="pb-5 font-semibold text-gray-800">{name}</div>
